/*
 Калькулятор конвертирующий Римские в Арабские цифры.
 Основной класс который принимает данные с второстепенных классов.
 */
public class Main {
    ...
    /*
 Класс определяющий арифмитический знак.
 */
