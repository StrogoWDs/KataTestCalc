/*
Класс принимает данные с Сканнера и сверяет их с Enum "Roman"
Если данные являются Римскими буквами, тогда берет эти переменные типа String
и переводит в тип int.
Так контралирует что бы числа не были > 10 и 1 <.
 */
public class Parse {
